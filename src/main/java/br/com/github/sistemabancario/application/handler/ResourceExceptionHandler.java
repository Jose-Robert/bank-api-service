...
import br.com.github.sistemabancario.application.service.exception.RecursoNaoSeuException;
...
public class ResourceExceptionHandler extends BaseExceptionHandler {
    ...
    @ExceptionHandler({ RecursoNaoSeuException.class })
    public ResponseEntity<Object> handleRecursoNaoSeuException(RecursoNaoSeuException exception, WebRequest request) {
        return handleException(exception, HttpStatus.BAD_REQUEST, request, "recurso.me.nao-possui");
    }
